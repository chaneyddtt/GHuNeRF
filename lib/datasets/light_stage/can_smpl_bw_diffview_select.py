...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # different embeddings for different camera views
        ...
        # select observed frames according to mesh distance
        idx = input_view[0]
        ...
        smpl_dist = torch.from_numpy(smpl_dist[smpl_index].astype(np.float32))
        if human in ['CoreView_313', 'CoreView_315']:
        ...
        for t in range(cfg.time_steps):
            ...
            for i in range(num_inputs):
                ...
                # get visibility map for feature aggregation
                if cfg.rasterize:
            ...
            # save parameters to transform target frame to observed frames
