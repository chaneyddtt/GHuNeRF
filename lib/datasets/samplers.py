...
from lib.datasets import get_human_info, get_human_info_snapshot
...
class FrameSampler(Sampler):
    ...
    def __init__(self, dataset):
        ...
        if data_name == 'people_snapshot':
            print('Sampler: people snapshot')
            human_info = get_human_info_snapshot.get_human_info(dataset.split)
        else:
            print('Sampler: zju mocap')
        ...
        if cfg.run_mode == 'train':
            cfg.zju_313_315_sample_cam = [3]
            cfg.zju_sample_cam = [3]
        ...
        for human_idx in range(len(human_list)):
            ...
            if cfg.same_view and cfg.run_mode == 'test':
                num_frames = ni - cfg.time_steps
            else:
                num_frames = ni
            ...
            if data_name == 'people_snapshot':
                sub_inds = sub_inds.reshape(num_frames, -1)[::5]
            else:
